...
void eve_ubooneFull(TString fstr ="../sim/mCP_q_0.010_m_0.020_fhc_pi0s.root" )
{
  ...
  while ( reader.Next() ) {
    ...
    Mom3 = rot*Mom3;
    TEveVector trackDir(Mom3.X()/Mom3.Mag(), Mom3.Y()/Mom3.Mag() ,Mom3.Z()/Mom3.Mag());
    Float_t length = Mom3.Mag()*1000;
